  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <div className="form-group image-select">
        {!file && (
          <div {...getRootProps({className: 'dropzone'})}>
            ...
            <input {...getInputProps()} />
            <p>Drag 'n' drop your image here, <br /> or click to select your image</p>
          </div>
        )}
      ...
      <div className="form-group">
        ...
        <p>
          <input name="lnaddress" type="text" value={lnAddress} onChange={(e) => { setLnAddress(e.target.value.trim()); } } />
          <small className="note">This is where the sats will be sent when your image is viewed</small>
        </p>
      </div>
      <div className="form-group">
        <label htmlFor="price">Price in sats</label>
        <p>
          <input min="1" name="price" type="number" value={price} onChange={(e) => { setPrice(e.target.value.trim()); } }  />
        </p>
      </div>
      <div className="form-group">
        <button type="submit" disabled={!file || !lnAddress || !price || uploading} className="button">
